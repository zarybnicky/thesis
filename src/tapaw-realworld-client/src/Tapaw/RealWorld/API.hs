...
type ConduitAPI
    ...
    :<|> "articles" :> QueryParam "tag" Text :> QueryParam "author" Text :> QueryParam "favorited" Text :> QueryParam "limit" Int :> QueryParam "offset" Int :> Verb 'GET 200 '[JSON] MultipleArticlesResponse -- 'getArticles' route
